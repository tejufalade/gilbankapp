    ...
    <div className='w-screen bg-[#E9EEF1] h-16 flex justify-between px-8 items-center border-b-4 sticky top-0 left-0 right-0 z-50 '>
        ...
        <nav className='w-1/2 relative'>
            <ul className='flex justify-between items-center'>
                ...
                <li className='w-24 h-10 p-2 bg-[#4BBDFD] rounded-md text-white flex items-center justify-center font-semibold cursor-pointer hover:bg-[#01659D]' onClick={()=>{setOpen(!open)}}>Log In</li>
